...
setwd("I:/psivakumar/Emer_CH/gwas/euro_uk_no_esp_gre/SAIGE_results")
...
#unimputed manhattan
unimp.model <- fread("I:/psivakumar/Emer_CH/gwas/euro_uk_no_esp_gre/unimputed_fishers/unimputed_fishers.model")
...
#write.table(unimp.alt.lambda, "I:/psivakumar/Emer_CH/gwas/euro_uk_no_esp_gre/unimputed_fishers/lambda_value.txt")

unimp.sig <- filter(unimp.model.plotting, P < 5E-06)
#fwrite(unimp.sig, "I:/psivakumar/Emer_CH/gwas/euro_uk_no_esp_gre/unimputed_fishers/unimputed_sig.csv")
