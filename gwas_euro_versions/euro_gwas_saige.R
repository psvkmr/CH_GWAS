...
setwd("I:/psivakumar/Emer_CH/gwas/euro_analysis/SAIGE_results")
...
#fwrite(saige.sig, "imputed_sig.csv")
...
#unimputed manhattan
setwd("I:/psivakumar/Emer_CH/gwas/euro_uk_analysis/unimputed_fishers")

unimp.model <- fread("unimputed_fishers.model")
