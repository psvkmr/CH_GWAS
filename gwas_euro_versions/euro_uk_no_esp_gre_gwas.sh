...
awk '{print $2,"ich_"$1"_"$2,$3,$4,$5,$6}' ich_4_commonSnps.fam > rename_ich.txt
mv rename_ich.txt ich_4_commonSnps.fam
...
#plink --bfile all_6_noStrandIssue --remove unknown_gsa2019_ids_remove.txt --make-bed --out all_6_noStrandIssue
...
awk '$10>0.2 {print $1,$2}' relCheck.genome | sed '1d' | uniq > duplicateSamples.txt
