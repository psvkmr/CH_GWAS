...
plink --bfile swedish_3_biallelic --extract commonSnpsToExtract.txt --make-bed --recode --out swedish_4_commonSnps
# rename samples
awk '{print $2,"GSA2016:"$1":"$2,$3,$4,$5,$6}' GSA2016_4_commonSnps.fam > rename_GSA2016.txt
...
awk '{print $2,"GSA2018:"$1":"$2,$3,$4,$5,$6}' GSA2018_4_commonSnps.fam > rename_GSA2018.txt
mv rename_GSA2018.txt GSA2018_4_commonSnps.fam
awk '{print $2,"1958c:"$1":"$2,$3,$4,$5,$6}' 1958c_4_commonSnps.fam > rename_1958c.txt
mv rename_1958c.txt 1958c_4_commonSnps.fam
awk '{print $2,"nbs:"$1":"$2,$3,$4,$5,$6}' nbs_4_commonSnps.fam > rename_nbs.txt
mv rename_nbs.txt nbs_4_commonSnps.fam
awk '{print $2,"reseq:"$1":"$2,$3,$4,$5,$6}' reseq_4_commonSnps.fam > rename_reseq.txt
mv rename_reseq.txt reseq_4_commonSnps.fam
awk '{print $2,"swedish:"$1":"$2,$3,$4,$5,$6}' swedish_4_commonSnps.fam > rename_swedish.txt
mv rename_swedish.txt swedish_4_commonSnps.fam
# merge
...
plink --bfile tmp4 --bmerge swedish_4_commonSnps --merge-mode 4 --out all_5_merged
...
plink --bfile all_18_noHetOutliers --remove duplicateSamples.txt --make-bed --out all_20_noDups
...
for i in `seq 1 22`
do
        unzip -P'fC7w#EI3uc-SNk' chr_${i}.zip &
done
unzip chr_X.zip
# check sample orders
...
Rscript /hades/Software/NGS_Software/SAIGE/extdata/step1_fitNULLGLMM.R \
        --plinkFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/saige_all_26 \
        --phenoFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/saige.pheno \
        --phenoCol=Phenotype \
        --covarColList=PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10,PC11,PC12,PC13,PC14,PC15,PC16,PC17,PC18,PC19,PC20 \
        --sampleIDColinphenoFile=IID \
        --traitType=binary \
        --skipModelFitting=FALSE \
        --outputPrefix=/hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step1 \
        --nThreads=2 \
        &> /hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step1.log
...
saige_step2(){
  Rscript /hades/Software/NGS_Software/SAIGE/extdata/step2_SPAtests.R \
          --vcfFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/chr$1.imputed.filt.vcf.gz \
          --vcfFileIndex=/hades/psivakumar/Emer_CH/uk_swedish_alt/chr$1.imputed.filt.vcf.gz.tbi \
          --vcfField=DS \
          --chrom=$1 \
          --minMAC=1 \
          --sampleFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/saige.sample \
          --GMMATmodelFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step1.rda \
          --varianceRatioFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step1.varianceRatio.txt \
          --SAIGEOutputFile=/hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step2_chr$1_output.txt \
          --numLinesOutput=2 \
...
for i in `seq 1 22`
do
    saige_step2 ${i} &> /hades/psivakumar/Emer_CH/uk_swedish_alt/SAIGE_step2_chr${i}.log &
done
