...
setwd("I:/psivakumar/Emer_CH/gwas/uk_only_gwas/SAIGE_results")
...
#  fwrite(locuszoom_data[[i]], paste0("I:/psivakumar/Emer_CH/gwas/uk_only_gwas/locuszoom/lz_chr", chr.order[i], ".txt", sep = ""), sep = '\t')
#}

#unimputed manhattan
unimp.model <- fread("I:/psivakumar/Emer_CH/gwas/uk_only_gwas/unimputed_fishers/unimputed_fishers.model")
...
#write.table(unimp.lambda, "I:/psivakumar/Emer_CH/gwas/uk_only_gwas/unimputed_fishers/unimputed_lambda.txt")
...
#fwrite(unimp.sig, "I:/psivakumar/Emer_CH/gwas/uk_only_gwas/unimputed_fishers/unimputed_sig.csv")

unimp.lz.data <- unimp.model.plotting %>% dplyr::select("CHR", "POS", "P") %>% unite("ID", c("CHR", "POS"), sep = ":") %>% arrange(P)
#fwrite(unimp.lz.data, "I:/psivakumar/Emer_CH/gwas/uk_only_gwas/locuszoom/unimputed_lz_data.txt", sep = '\t')
