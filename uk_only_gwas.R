...
setwd("I:/psivakumar/Emer_CH/gwas/uk_only_gwas")
...
uk.controls <- bind_rows(c1958.fam, nbs.fam)$V2
...
frq.list <- list(gsa2016.frq, gsa2018.frq, c1958.frq, nbs.frq, reseq.frq)
...
all.5.fam$V6 <- ifelse(all.5.fam$V1 %in% uk.cases, 2, 
                       ifelse(all.5.fam$V1 %in% uk.controls, 1, -9))
